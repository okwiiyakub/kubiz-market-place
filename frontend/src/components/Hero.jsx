        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 shadow-xl">
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-white text-gray-800 rounded-2xl p-5 shadow-md">
              ...
              <p className="text-sm text-gray-600">Laptops, desktops, accessories</p>
            </div>

            <div className="bg-white text-gray-800 rounded-2xl p-5 shadow-md">
              <h3 className="font-bold text-lg mb-2">Phones</h3>
              <p className="text-sm text-gray-600">Smartphones and mobile accessories</p>
            </div>

            <div className="bg-white text-gray-800 rounded-2xl p-5 shadow-md">
              <h3 className="font-bold text-lg mb-2">Insurance</h3>
              <p className="text-sm text-gray-600">Trusted protection services</p>
            </div>

            <div className="bg-white text-gray-800 rounded-2xl p-5 shadow-md">
              <h3 className="font-bold text-lg mb-2">Digital</h3>
              <p className="text-sm text-gray-600">Software and online products</p>
            </div>
          </div>
        </div>
      </div>
